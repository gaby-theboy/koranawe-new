...
function CustomModal({ isOpen, onClose, title, message, confirmText = "Yego", cancelText = "Oya" }: {
  isOpen: boolean;
  onClose: () => void;
  title: string;
  message: string;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl animate-in fade-in-0 zoom-in-95">
        <div className="p-6">
...
function LogoutModal({ isOpen, onClose, onConfirm }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl animate-in fade-in-0 zoom-in-95">
        <div className="p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Ushaka kumara?</h3>
          <p className="text-gray-600 mb-6">Urabyemera ko ushaka kusohoka mu konti yawe?</p>
...
export default function AccountPage() {
  ...
  const [activeSection, setActiveSection] = useState("settings"); // Default to "Konti Yange"
    ...
    switch (activeSection) {
      ...
      case "about":
        return (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold text-gray-900">Ibyerekeye KoraNawe</h2>
              <Button 
                variant="outline" 
                onClick={() => setActiveSection("settings")}
                className="text-sm"
        ...
        <div className="hidden md:block">
          <div className="max-w-7xl mx-auto px-8 py-8">
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-4">
                <Card className={`shadow-lg border-0 sticky top-8 bg-gradient-to-b ${
                  ...
                  <CardContent className="p-6">
                    ...
                    {/* Navigation - Only 3 options */}
                    <div className="space-y-2 mb-6">
                      {/* Konti Yange - Default active */}
                      <Button
              ...
              {/* Content Area - Shows "Konti Yange" by default */}
